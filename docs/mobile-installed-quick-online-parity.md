...
| Hand reveal intro | quick reveal phases | online `MATCH_STARTED` / hand reveal phase | Intro `2400ms`; hand reveal phase `1400ms`; per-card flip path is identical | Timing pinned; card population owned by reveal task |
