...
class MixedLocalCoordinatorTests(unittest.TestCase):
    ...
    def test_materialized_plan_uses_exact_paths_and_only_deferred_plan_sentinel(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            source = root / "source"
            actor = root / "actor"
            run = root / "v4-fixedid-ppo-i001-mixedmathfp32env-s660000001-local-run-001"
            ...
            replacements = _materialized_replacements(
                ...
                remote_run="/home/pangmin/dalmuti/v4-fixedid-ppo-i001-mixedmathfp32env-s660000001-run-001",
    ...
    def test_recipe_enforces_exact_local_and_remote_run_paths(self) -> None:
        ...
        local = Path(
            "C:/runs/v4-fixedid-ppo-i001-mixedmathfp32env-s660000001-local-run-001"
        )
        remote = "/home/pangmin/dalmuti/v4-fixedid-ppo-i001-mixedmathfp32env-s660000001-run-001"
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with self.assertRaises(FileNotFoundError):
                execute_mixed_workflow(
                    ...
                    remote_run_directory="/home/pangmin/dalmuti/v4-fixedid-ppo-i001-mixedmathfp32env-s660000001-run-001",
